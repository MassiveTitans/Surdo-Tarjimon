    ...
    with mp_hands.Hands(static_image_mode=False, max_num_hands=1, min_detection_confidence=0.5) as hands:
        while cap.isOpened() :
            ...
            if not results.multi_hand_landmarks:
                ...
                image = cv2.putText(image, pred, (20, 90) , cv2.FONT_HERSHEY_SIMPLEX, 3, (0, 0, 0), 2)

                # blackboard = np.zeros((480, 640, 3), dtype=np.uint8)
                # im = cv2.putText(blackboard, "       ", (180, 100), cv2.FONT_HERSHEY_TRIPLEX, 1.5, (255, 0, 0))
                # cv2.putText(blackboard, "Predicted-" + pred, (180, 220), cv2.FONT_HERSHEY_TRIPLEX, 1, (255, 255, 0))
                # cv2.putText(blackboard, str(pred), (30, 150), cv2.FONT_HERSHEY_TRIPLEX, 1, (255, 255, 0))
